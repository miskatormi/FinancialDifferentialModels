...
*Linear ODE simulation capability of the Core solver*
...
![AAPL](https://github.com/miskatormi/FinancialDifferentialModels/blob/main/figures/AAPL_GBM_forecast.png)
